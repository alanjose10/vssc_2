            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Completed Re-Screens</h3>
                    </div>
                        ...
                        <table class="table table-hover table-bordered">
                            ...
                            <tbody>
                                ...
                                foreach($rescreens as $row){
                                    echo "<tr id=\"row\" href=\"".base_url().'verifier/view_completed_rescreen/'.$row['rescreen_id']."\">";
