    ...
    <section class="content">
        ...
        <div class="col-lg-4 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            ...
            <a href="<?php echo base_url().'verifier/view_siv_list/PENDING_APPROVAL'; ?>" class="small-box-footer">
        ...
        <div class="col-lg-4 col-xs-6">
          ...
          <div class="small-box bg-green">
            ...
            <a href="<?php echo base_url().'verifier/view_siv_list/APPROVED'; ?>" class="small-box-footer">
              View SIVs <i class="fa fa-arrow-circle-right"></i>
            </a>
          </div>
        </div>
        ...
        <div class="col-lg-4 col-xs-6">
          ...
          <div class="small-box bg-red">
            ...
            <a href="<?php echo base_url().'verifier/view_siv_list/REJECTED'; ?>" class="small-box-footer">
               View SIVs <i class="fa fa-arrow-circle-right"></i>
            </a>
          </div>
        </div>
    ...
    <div class="row">       <!--boms-->
        <div class="col-lg-4 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            ...
            <a href="<?php echo base_url().'verifier/view_assembled_bom_list/PENDING_APPROVAL'; ?>" class="small-box-footer">
        ...
        <div class="col-lg-4 col-xs-6">
          ...
          <div class="small-box bg-green">
            ...
            <a href="<?php echo base_url().'verifier/view_assembled_bom_list/APPROVED'; ?>" class="small-box-footer">
              View BOMs <i class="fa fa-arrow-circle-right"></i>
            </a>
          </div>
        </div>
        ...
        <div class="col-lg-4 col-xs-6">
          ...
          <div class="small-box bg-red">
            ...
            <a href="<?php echo base_url().'verifier/view_assembled_bom_list/REJECTED'; ?>" class="small-box-footer">
               View BOMs <i class="fa fa-arrow-circle-right"></i>
            </a>
          </div>
        </div>
