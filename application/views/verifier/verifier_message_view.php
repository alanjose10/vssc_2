                        ...
                        <div class="panel panel-danger ">
                            <div class="panel-heading bg-purple">
                                <div class="row">
                                    ...
                                    <div class="col-xs-3">
                                        <form role="form-horizontal" action="<?php echo base_url().'user/message'; ?>" method="post">
                            ...
                            <div class="row">
                                <div class="col-xs-10">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <form role="form-horizontal" action="<?php echo base_url().'user/add_message'; ?>" method="post">
                                                <div class="box-footer">
                            ...
                            <div class="panel-body transparent">
                                ...
                                foreach($user_names as $row)   {
                                                ...
                                                print "<div class=\"row\">\n";
                                                print "<a href=\"".base_url()."verifier/message/".$row['user_name']."\">";
                                                print "<div class=\"box\">\n";
