 <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <h1>
        Add New Verifier<small>Please enter new verifier details.</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Dashboard</a></li>
        <li class="active">Add New Verifier</li>
      </ol>
    </section>
    <!-- Main content -->
            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h3 class="box-title">Enter New Verifier Details</h3>
                    </div>
                    <form role="form-horizontal" action="<?php echo base_url().'admin/add_verifier'; ?>" method="post">
                        <div class="box-body">
                        ...
                        <div class="row">
                            <div class="col-xs-2 col-xs-offset-5">
                                <div class="box-footer">
                                    <button type="submit" class="btn btn-flat bg-red btn-lg" value="submit">Add Verifier</button>
                                    <br><p>
                                    <?php       //not working?
