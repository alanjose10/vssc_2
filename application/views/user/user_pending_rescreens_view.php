...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Pending Re-Screens</li>
      </ol>
    </section>
            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title"> Re-Screens</h3>
                    </div>
                        ...
                        <table class="table table-hover table-bordered">
                            ...
                            <tbody>
                                ...
                                foreach($rescreens as $row){
                                    echo "<tr id=\"row\" href=\"".base_url().'user/perform_rescreen/'.$row['rescreen_id']."\">";
                                    ...
                                    echo "<td><span class=\"label label-warning\">".$row['rescreen_status']."</span></td>\n";
                                    /*
