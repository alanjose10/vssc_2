 <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        BOM List
        <small>Please choose from the list of uploaded BOMs</small>
      </h1>
      <ol class="breadcrumb">
        <li><i class="fa fa-dashboard"></i> Dashboard</li>
        <li class="active">Choose BOM</li>
      </ol>
    </section>
    <!-- Main content -->
    <section class="content">
        <?php
            ...
            foreach($uploaded_boms as $row){
                ...
                echo "</div>";
                echo "<a href=\"".base_url()."user/enter_bom_details/".$row['bom_no']."\" class=\"small-box-footer\">";
                echo "Enter BOM <i class=\"fa fa-arrow-circle-right\"></i>";
                echo "</a>";
                echo " </div>  ";
                echo "</div>";
                echo "</div>";
